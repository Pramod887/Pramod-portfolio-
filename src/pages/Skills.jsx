...
const ROWS = [
  [
    ...
    { title: "Web Technologies", items: ["HTML", "CSS", "JavaScript", "Kotlin"] },
    { title: "Databases & Tools", items: ["MySQL", "Firebase", "Git"] },
  ],
  [
    {
      title: "Core Concepts",
    ...
    {
      title: "Soft Skills",
      items: ["Teamwork", "Problem Solving", "Creativity", "Adaptability", "Communication","Time management"],
    },
  ],
];
